/**
 * Tests for all ORM adapter enhancements — Memory utilities, JSON adapter
 * utilities, and structural tests for MySQL, PostgreSQL, MongoDB adapters
 * (constructor options, method existence, credential validation).
 *
 * MySQL/PG/Mongo CRUD is not tested here because they require running servers.
 * What IS tested: option documentation, method signatures, error handling.
 */
const fs   = require('fs');
