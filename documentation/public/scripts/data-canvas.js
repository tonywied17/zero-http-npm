 ...
 * A network of nodes connected by faint edges, with data
 * pulses constantly traveling between them. Every node stays
 * active — no idle dots.
...
(function () {
    ...
    function seed() {
        ...
        for (let i = 0; i < count; i++) {
            ...
            nodes.push({
                ...
                edges: [] /* track which edges touch this node */
            });
        }

        /* Connect nearby nodes — each gets 1-3 neighbours */
        ...
        /* Remove any node with zero edges — shouldn't happen
           with the above logic but just in case */
    ...
    /* Ensure every node always has at least one active pulse
       on one of its edges */
    ...
    function draw() {
        ...
        /* Periodically spawn extra pulses + ensure no idle nodes */
        if (tick % 30 === 0) {
