#!/usr/bin/env node
/**
 * build-api-md.js — Generate API.md from docs.json
 *
 * Reads documentation/public/data/docs.json and produces a comprehensive
 * Markdown API reference. Static sections (header, exports table, examples)
 * are embedded in this script; everything else is generated from docs.json.
 *
...
function build()
{
    const data = JSON.parse(fs.readFileSync(DOCS_JSON, 'utf8'));
    ...
    console.log(`✓ API.md generated (${lines} lines) from docs.json`);
}
